...
mkdir -p /home/ubuntu/results/bdrmap
mkdir -p /home/ubuntu/results/speedtest

bash /home/ubuntu/outdir/softwares/speedtest/setupspeedtest.bash

if [[ $2 == "amazon" ]]; then sudo apt-get install -y awscli; fi
if [[ $2 == "azure" ]]; then 
    curl -sL https://aka.ms/InstallAzureCLIDeb | sudo bash;
    cd /home/ubuntu; wget -O azcopy_v10.tar.gz https://aka.ms/downloadazcopy-v10-linux && tar -xf azcopy_v10.tar.gz --strip-components=1; sudo mv azcopy /usr/local/bin;
    azcopy login --identity
    sudo chown -R ubuntu /home/ubuntu/.azcopy;
fi

#also need to install cron jobs
crontab /home/ubuntu/outdir/softwares/expr.cron
echo "SETUP DONE"
